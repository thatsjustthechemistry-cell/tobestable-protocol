...
No team allocation. No pre-mine. No insiders. Founder mints under the same rules as everyone else. Smart contracts open-sourced on GitHub. Authority controlled by Squads multisig.
```
